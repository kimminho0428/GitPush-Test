 ...
 * <li>file record class: {@link Cbtrn03cFdTranfileRec}</li>
 * </ul>
 */
public abstract class Cbtrn03cFileOpTransactFile implements
        FileBaseOperation<Cbtrn03cFdTranfileRec, Long> {
    public Cbtrn03cFdTranfileRec readNext(OpenFrameContext context) {
    ...
    protected void setCurrentSeqId(OpenFrameContext context, Long currentSeqId) {
        context.setFileSeqId("Cbtrn03c", "TransactFile", currentSeqId);
    }

    public Long getCurrentSeqId(OpenFrameContext context) {
        return context.getFileSeqId("Cbtrn03c", "TransactFile");
    }
    ...
    public void setFileStatus(OpenFrameContext context, FileStatus status) {
        ...
        context.setFileStatus("Cbtrn03c", "TransactFile", status);
    }

    public FileStatus getFileStatus(OpenFrameContext context) {
        return context.getFileStatus("Cbtrn03c", "TransactFile");
    }
}
