 ...
 * <ul>
 * <li>File description name: REPORT-FILE</li>
 * <li>file record class: {@link String}</li>
 * </ul>
 */
public abstract class Cbtrn03cFileOpReportFile implements
    ...
    protected void setCurrentSeqId(OpenFrameContext context, Long currentSeqId) {
        context.setFileSeqId("Cbtrn03c", "ReportFile", currentSeqId);
    }

    public Long getCurrentSeqId(OpenFrameContext context) {
        return context.getFileSeqId("Cbtrn03c", "ReportFile");
    }
    ...
    public void setFileStatus(OpenFrameContext context, FileStatus status) {
        ...
        container.getTranreptStatus().set(status.getValue());
        context.setFileStatus("Cbtrn03c", "ReportFile", status);
    }

    public FileStatus getFileStatus(OpenFrameContext context) {
        return context.getFileStatus("Cbtrn03c", "ReportFile");
    }
}
