 ...
 * <li>file record class: {@link Cbtrn01cFdTranfileRec}</li>
 * <li>key field: {@link Cbtrn01cFdTranfileRec#fdTransId}</li>
 * </ul>
 */
public abstract class Cbtrn01cFileOpTransactFile implements
        FileBaseOperation<Cbtrn01cFdTranfileRec, String> {
    public Cbtrn01cFdTranfileRec readNext(OpenFrameContext context) {
    ...
    public void setFileStatus(OpenFrameContext context, FileStatus status) {
        ...
        context.setFileStatus("Cbtrn01c", "TransactFile", status);
    }

    public FileStatus getFileStatus(OpenFrameContext context) {
        return context.getFileStatus("Cbtrn01c", "TransactFile");
    }
}
