...
public interface CocrdlicMapperInterface {
     ...
     * <ul>
     * <li>source class: {@link CocrdlicWsThisProgcommarea.CocrdlicWsCaFirstCardkey}</li>
     * <li>target class: {@link CocrdlicWsThisProgcommarea.CocrdlicWsCaLastCardkey}</li>
     * </ul>
     */
    class CocrdlicWsThisProgcommareaCocrdlicWsCaFirstCardkeyToCocrdlicWsThisProgcommareaCocrdlicWsCaLastCardkey {
        public static void set(
                CocrdlicWsThisProgcommarea.CocrdlicWsCaFirstCardkey source,
                CocrdlicWsThisProgcommarea.CocrdlicWsCaLastCardkey target) {
            target.setWsCaLastCardNum(source.getWsCaFirstCardNum());
            target.setWsCaLastCardAcctId(source.getWsCaFirstCardAcctId());
        }
    }
}
