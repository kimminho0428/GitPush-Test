...
import com.tmax.openframe.variable.group.CoactvwcDfhcommarea;
...
import com.tmax.openframe.variable.group.CoactupcDfhcommarea;
import com.tmax.openframe.variable.group.CocrdslcDfhcommarea;
import com.tmax.openframe.variable.group.Comen01cDfhcommarea;
import com.tmax.openframe.variable.group.CocrdupcDfhcommarea;
...
public interface Comen01cMapperInterface {
    ...
    public interface CarddemoCommareaToCoactvwcDfhcommarea {
        CarddemoCommareaToCoactvwcDfhcommarea INSTANCE = Mappers
                .getMapper(CarddemoCommareaToCoactvwcDfhcommarea.class);

        CoactvwcDfhcommarea toTarget(CarddemoCommarea source);

        CarddemoCommarea toSource(CoactvwcDfhcommarea source);
     ...
     */
    @Mapper(unmappedTargetPolicy = ReportingPolicy.IGNORE, builder = @org.mapstruct.Builder(disableBuilder = true))
    public interface CarddemoCommareaToCotrn01cDfhcommarea {
        CarddemoCommareaToCotrn01cDfhcommarea INSTANCE = Mappers
                .getMapper(CarddemoCommareaToCotrn01cDfhcommarea.class);

        Cotrn01cDfhcommarea toTarget(CarddemoCommarea source);

        CarddemoCommarea toSource(Cotrn01cDfhcommarea source);
     ...
     */
    @Mapper(unmappedTargetPolicy = ReportingPolicy.IGNORE, builder = @org.mapstruct.Builder(disableBuilder = true))
    public interface CarddemoCommareaToCobil00cDfhcommarea {
        CarddemoCommareaToCobil00cDfhcommarea INSTANCE = Mappers
                .getMapper(CarddemoCommareaToCobil00cDfhcommarea.class);

        Cobil00cDfhcommarea toTarget(CarddemoCommarea source);

        CarddemoCommarea toSource(Cobil00cDfhcommarea source);
     ...
     */
    @Mapper(unmappedTargetPolicy = ReportingPolicy.IGNORE, builder = @org.mapstruct.Builder(disableBuilder = true))
    public interface CarddemoCommareaToCotrn02cDfhcommarea {
        CarddemoCommareaToCotrn02cDfhcommarea INSTANCE = Mappers
                .getMapper(CarddemoCommareaToCotrn02cDfhcommarea.class);

        Cotrn02cDfhcommarea toTarget(CarddemoCommarea source);

        CarddemoCommarea toSource(Cotrn02cDfhcommarea source);
     ...
     */
    @Mapper(unmappedTargetPolicy = ReportingPolicy.IGNORE, builder = @org.mapstruct.Builder(disableBuilder = true))
    public interface CarddemoCommareaToCoactupcDfhcommarea {
        CarddemoCommareaToCoactupcDfhcommarea INSTANCE = Mappers
                .getMapper(CarddemoCommareaToCoactupcDfhcommarea.class);

        CoactupcDfhcommarea toTarget(CarddemoCommarea source);

        CarddemoCommarea toSource(CoactupcDfhcommarea source);
     ...
     */
    @Mapper(unmappedTargetPolicy = ReportingPolicy.IGNORE, builder = @org.mapstruct.Builder(disableBuilder = true))
    public interface CarddemoCommareaToCocrdslcDfhcommarea {
        CarddemoCommareaToCocrdslcDfhcommarea INSTANCE = Mappers
                .getMapper(CarddemoCommareaToCocrdslcDfhcommarea.class);

        CocrdslcDfhcommarea toTarget(CarddemoCommarea source);

        CarddemoCommarea toSource(CocrdslcDfhcommarea source);
     ...
     */
    @Mapper(unmappedTargetPolicy = ReportingPolicy.IGNORE, builder = @org.mapstruct.Builder(disableBuilder = true))
    public interface CarddemoCommareaToCocrdupcDfhcommarea {
        CarddemoCommareaToCocrdupcDfhcommarea INSTANCE = Mappers
                .getMapper(CarddemoCommareaToCocrdupcDfhcommarea.class);

        CocrdupcDfhcommarea toTarget(CarddemoCommarea source);

        CarddemoCommarea toSource(CocrdupcDfhcommarea source);
     ...
     */
    @Mapper(unmappedTargetPolicy = ReportingPolicy.IGNORE, builder = @org.mapstruct.Builder(disableBuilder = true))
    public interface CarddemoCommareaToCotrn00cDfhcommarea {
        CarddemoCommareaToCotrn00cDfhcommarea INSTANCE = Mappers
                .getMapper(CarddemoCommareaToCotrn00cDfhcommarea.class);

        Cotrn00cDfhcommarea toTarget(CarddemoCommarea source);

        CarddemoCommarea toSource(Cotrn00cDfhcommarea source);
