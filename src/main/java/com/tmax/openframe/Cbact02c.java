...
import static com.tmax.openframe.variable.Cbact02cVariableContainer.*;
import com.tmax.openframe.file.*;
import com.tmax.openframe.mapper.Cbact02cMapperInterface;
...
public class Cbact02c {
    ...
    /** 
     * <p>[T-Up#INFO][CBACT02C.cbl:92] 1000-CARDFILE-GET-NEXT Paragraph</p>
     */
    void _1000CardfileGetNext(OpenFrameContext context) {
        ...
        if (tempCbact02cFdCardfileRec1 != null) {
            ...
            Cbact02cMapperInterface.Cbact02cFdCardfileRecToCardRecord.set(
                    container.getFdCardfileRec(), container.getCardRecord());
        }
        // [T-Up#INFO][CBACT02C.cbl:94] IF statement
        if (CobStringUtils.compare(container.getCardfileStatus().get(), "00") == 0) {
            // [T-Up#INFO][CBACT02C.cbl:95] MOVE statement
            container.setApplResult(0);
        } else {
            // *        DISPLAY CARD-RECORD
            // [T-Up#INFO][CBACT02C.cbl:98] IF statement
            if (CobStringUtils.compare(container.getCardfileStatus().get(),
                    "10") == 0) {
                // [T-Up#INFO][CBACT02C.cbl:99] MOVE statement
                container.setApplResult(16);
            } else {
                // [T-Up#INFO][CBACT02C.cbl:101] MOVE statement
                container.setApplResult(12);
            }
        }
        // [T-Up#INFO][CBACT02C.cbl:104] IF statement
        if (container.getApplResult() == APPL_AOK) {
            // [T-Up#INFO][CBACT02C.cbl:105] CONTINUE statement
        } else {
            // [T-Up#INFO][CBACT02C.cbl:107] IF statement
            if (container.getApplResult() == APPL_EOF) {
                // [T-Up#INFO][CBACT02C.cbl:108] MOVE statement
                container.setEndOfFile("Y");
            } else {
                // [T-Up#INFO][CBACT02C.cbl:110] DISPLAY statement
                System.out.println("ERROR READING CARDFILE");
                // [T-Up#INFO][CBACT02C.cbl:111] MOVE statement
                Cbact02cMapperInterface.Cbact02cCardfileStatusToCbact02cIoStatus
                        .set(container.getCardfileStatus(),
                                container.getIoStatus());
                // [T-Up#INFO][CBACT02C.cbl:112] PERFORM statement
                controlManager.run(context, _9910DisplayIoStatus);
                if (controlManager.isTerminate(context)) {
                    return;
                }
                // [T-Up#INFO][CBACT02C.cbl:113] PERFORM statement
        ...
        // [T-Up#INFO][CBACT02C.cbl:116] EXIT statement
    }

    // *---------------------------------------------------------------*

    /** 
     * <p>[T-Up#INFO][CBACT02C.cbl:118] 0000-CARDFILE-OPEN Paragraph</p>
     */
    void _0000CardfileOpen(OpenFrameContext context) {
        Cbact02cVariableContainer container = (Cbact02cVariableContainer) context
                .getProgramVariableContainer("Cbact02c");
        // [T-Up#INFO][CBACT02C.cbl:119] MOVE statement
        container.setApplResult(8);
        // [T-Up#INFO][CBACT02C.cbl:120] OPEN statement
        fdCardfileFile.open(context);
        // [T-Up#INFO][CBACT02C.cbl:121] IF statement
        if (CobStringUtils.compare(container.getCardfileStatus().get(), "00") == 0) {
            // [T-Up#INFO][CBACT02C.cbl:122] MOVE statement
            container.setApplResult(0);
        } else {
            // [T-Up#INFO][CBACT02C.cbl:124] MOVE statement
            container.setApplResult(12);
        }
        // [T-Up#INFO][CBACT02C.cbl:126] IF statement
        if (container.getApplResult() == APPL_AOK) {
            // [T-Up#INFO][CBACT02C.cbl:127] CONTINUE statement
        } else {
            // [T-Up#INFO][CBACT02C.cbl:129] DISPLAY statement
            System.out.println("ERROR OPENING CARDFILE");
            // [T-Up#INFO][CBACT02C.cbl:130] MOVE statement
            Cbact02cMapperInterface.Cbact02cCardfileStatusToCbact02cIoStatus
                    .set(container.getCardfileStatus(), container.getIoStatus());
            // [T-Up#INFO][CBACT02C.cbl:131] PERFORM statement
            controlManager.run(context, _9910DisplayIoStatus);
            if (controlManager.isTerminate(context)) {
                return;
            }
            // [T-Up#INFO][CBACT02C.cbl:132] PERFORM statement
            controlManager.run(context, _9999AbendProgram);
            if (controlManager.isTerminate(context)) {
                return;
            }
        }
        // [T-Up#INFO][CBACT02C.cbl:134] EXIT statement
    }

    // *---------------------------------------------------------------*

    /** 
     * <p>[T-Up#INFO][CBACT02C.cbl:136] 9000-CARDFILE-CLOSE Paragraph</p>
     */
    void _9000CardfileClose(OpenFrameContext context) {
        Cbact02cVariableContainer container = (Cbact02cVariableContainer) context
                .getProgramVariableContainer("Cbact02c");
        // [T-Up#INFO][CBACT02C.cbl:137] ADD statement
        container.setApplResult(8);
        // [T-Up#INFO][CBACT02C.cbl:138] CLOSE statement
        fdCardfileFile.close(context);
        // [T-Up#INFO][CBACT02C.cbl:139] IF statement
        if (CobStringUtils.compare(container.getCardfileStatus().get(), "00") == 0) {
            // [T-Up#INFO][CBACT02C.cbl:140] SUBTRACT statement
            container.setApplResult(container.getApplResult()
                    - container.getApplResult());
        } else {
            // [T-Up#INFO][CBACT02C.cbl:142] ADD statement
            container.setApplResult(12);
        }
        // [T-Up#INFO][CBACT02C.cbl:144] IF statement
        if (container.getApplResult() == APPL_AOK) {
            // [T-Up#INFO][CBACT02C.cbl:145] CONTINUE statement
        } else {
            // [T-Up#INFO][CBACT02C.cbl:147] DISPLAY statement
            System.out.println("ERROR CLOSING CARDFILE");
            // [T-Up#INFO][CBACT02C.cbl:148] MOVE statement
            Cbact02cMapperInterface.Cbact02cCardfileStatusToCbact02cIoStatus
                    .set(container.getCardfileStatus(), container.getIoStatus());
            // [T-Up#INFO][CBACT02C.cbl:149] PERFORM statement
            controlManager.run(context, _9910DisplayIoStatus);
            if (controlManager.isTerminate(context)) {
                return;
            }
            // [T-Up#INFO][CBACT02C.cbl:150] PERFORM statement
            controlManager.run(context, _9999AbendProgram);
            if (controlManager.isTerminate(context)) {
                return;
            }
        }
        // [T-Up#INFO][CBACT02C.cbl:152] EXIT statement
    }

    /** 
     * <p>[T-Up#INFO][CBACT02C.cbl:154] 9999-ABEND-PROGRAM Paragraph</p>
     */
    void _9999AbendProgram(OpenFrameContext context) {
        Cbact02cVariableContainer container = (Cbact02cVariableContainer) context
                .getProgramVariableContainer("Cbact02c");
        // [T-Up#INFO][CBACT02C.cbl:155] DISPLAY statement
        System.out.println("ABENDING PROGRAM");
        // [T-Up#INFO][CBACT02C.cbl:156] MOVE statement
        container.setTiming(0);
        // [T-Up#INFO][CBACT02C.cbl:157] MOVE statement
        container.setAbcode(999);
        // [T-Up#INFO][CBACT02C.cbl:158] CALL statement
