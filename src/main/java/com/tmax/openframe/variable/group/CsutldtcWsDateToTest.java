 ...
 * <hr>
 * <p>Class that defines variables for COBOL group item WS-DATE-TO-TEST</p>
 */
public @AllArgsConstructor @NoArgsConstructor class CsutldtcWsDateToTest {
    // [T-Up#INFO][CSUTLDTC.cbl:26] Vstring-length (level: 2)
    private @Getter @Setter int vstringLength;
    // [T-Up#INFO][CSUTLDTC.cbl:27] Vstring-text (level: 2)
    ...
    public static @AllArgsConstructor @NoArgsConstructor class CsutldtcVstringText {
        // [T-Up#INFO][CSUTLDTC.cbl:28] Vstring-char (level: 3)
