...
public @AllArgsConstructor @NoArgsConstructor class Cbact04cFdTranCatBalRecord {
    // [T-Up#INFO][CBACT04C.cbl:63] FD-TRAN-CAT-KEY (level: 5)
    private @Getter @Setter Cbact04cFdTranCatKey fdTranCatKey = new Cbact04cFdTranCatKey();
    // [T-Up#INFO][CBACT04C.cbl:67] FD-FD-TRAN-CAT-DATA (level: 5)
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cbact04cFdTranCatKey {
        // [T-Up#INFO][CBACT04C.cbl:64] FD-TRANCAT-ACCT-ID (level: 10)
        private @Getter @Setter long fdTrancatAcctId;
        // [T-Up#INFO][CBACT04C.cbl:65] FD-TRANCAT-TYPE-CD (level: 10)
        private @Getter String fdTrancatTypeCd = StringUtils.repeat(' ', 2);
        // [T-Up#INFO][CBACT04C.cbl:66] FD-TRANCAT-CD (level: 10)
