...
public @AllArgsConstructor @NoArgsConstructor class Coadm01cWsVariables {
    // [T-Up#INFO][COADM01C.cbl:36] WS-PGMNAME (level: 5)
    private @Getter String wsPgmname = "COADM01C";
    // [T-Up#INFO][COADM01C.cbl:37] WS-TRANID (level: 5)
    private @Getter String wsTranid = "CA00";
    // [T-Up#INFO][COADM01C.cbl:38] WS-MESSAGE (level: 5)
    private @Getter String wsMessage = StringUtils.repeat(' ', 80);
    // [T-Up#INFO][COADM01C.cbl:39] WS-USRSEC-FILE (level: 5)
    private @Getter String wsUsrsecFile = "USRSEC  ";
    // [T-Up#INFO][COADM01C.cbl:40] WS-ERR-FLG (level: 5)
    private @Getter String wsErrFlg = "N";
    // [T-Up#INFO][COADM01C.cbl:41] ERR-FLG-ON (level: 88)
    public static final String ERR_FLG_ON = "Y";
    // [T-Up#INFO][COADM01C.cbl:42] ERR-FLG-OFF (level: 88)
    public static final String ERR_FLG_OFF = "N";
    // [T-Up#INFO][COADM01C.cbl:43] WS-RESP-CD (level: 5)
    private @Getter @Setter int wsRespCd = 0;
    // [T-Up#INFO][COADM01C.cbl:44] WS-REAS-CD (level: 5)
    private @Getter @Setter int wsReasCd = 0;
    // [T-Up#INFO][COADM01C.cbl:45] WS-OPTION-X (level: 5)
    private @Getter String wsOptionX = StringUtils.repeat(' ', 2);
    // [T-Up#INFO][COADM01C.cbl:46] WS-OPTION (level: 5)
    private @Getter @Setter int wsOption = 0;
    // [T-Up#INFO][COADM01C.cbl:47] WS-IDX (level: 5)
    private @Getter @Setter int wsIdx = 0;
    // [T-Up#INFO][COADM01C.cbl:48] WS-ADMIN-OPT-TXT (level: 5)
