 ...
 */
public @AllArgsConstructor @NoArgsConstructor class EditCsutldtcParm {
    // [T-Up#INFO][EDIT2.cbl:130] CSUTLDTC-DATE (level: 5)
    private @Getter String csutldtcDate = StringUtils.repeat(' ', 10);
    // [T-Up#INFO][EDIT2.cbl:131] CSUTLDTC-DATE-FORMAT (level: 5)
    private @Getter String csutldtcDateFormat = StringUtils.repeat(' ', 10);
    // [T-Up#INFO][EDIT2.cbl:132] CSUTLDTC-RESULT (level: 5)
    private @Getter @Setter EditCsutldtcResult csutldtcResult = new EditCsutldtcResult();
    ...
    public static @AllArgsConstructor @NoArgsConstructor class EditCsutldtcResult {
        // [T-Up#INFO][EDIT2.cbl:133] CSUTLDTC-RESULT-SEV-CD (level: 10)
        private @Getter String csutldtcResultSevCd = StringUtils.repeat(' ', 4);
        // [T-Up#INFO][EDIT2.cbl:134] FILLER (level: 10)
        private @Getter String FILLER_1 = StringUtils.repeat(' ', 11);
        // [T-Up#INFO][EDIT2.cbl:135] CSUTLDTC-RESULT-MSG-NUM (level: 10)
        private @Getter String csutldtcResultMsgNum = StringUtils
                .repeat(' ', 4);
        // [T-Up#INFO][EDIT2.cbl:136] CSUTLDTC-RESULT-MSG (level: 10)
