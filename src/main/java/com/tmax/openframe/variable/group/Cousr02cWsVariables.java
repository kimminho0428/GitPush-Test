...
public @AllArgsConstructor @NoArgsConstructor class Cousr02cWsVariables {
    // [T-Up#INFO][COUSR02C.cbl:36] WS-PGMNAME (level: 5)
    private @Getter String wsPgmname = "COUSR02C";
    // [T-Up#INFO][COUSR02C.cbl:37] WS-TRANID (level: 5)
    private @Getter String wsTranid = "CU02";
    // [T-Up#INFO][COUSR02C.cbl:38] WS-MESSAGE (level: 5)
    private @Getter String wsMessage = StringUtils.repeat(' ', 80);
    // [T-Up#INFO][COUSR02C.cbl:39] WS-USRSEC-FILE (level: 5)
    private @Getter String wsUsrsecFile = "USRSEC  ";
    // [T-Up#INFO][COUSR02C.cbl:40] WS-ERR-FLG (level: 5)
    private @Getter String wsErrFlg = "N";
    // [T-Up#INFO][COUSR02C.cbl:41] ERR-FLG-ON (level: 88)
    public static final String ERR_FLG_ON = "Y";
    // [T-Up#INFO][COUSR02C.cbl:42] ERR-FLG-OFF (level: 88)
    public static final String ERR_FLG_OFF = "N";
    // [T-Up#INFO][COUSR02C.cbl:43] WS-RESP-CD (level: 5)
    private @Getter @Setter int wsRespCd = 0;
    // [T-Up#INFO][COUSR02C.cbl:44] WS-REAS-CD (level: 5)
    private @Getter @Setter int wsReasCd = 0;
    // [T-Up#INFO][COUSR02C.cbl:45] WS-USR-MODIFIED (level: 5)
    private @Getter String wsUsrModified = "N";
    // [T-Up#INFO][COUSR02C.cbl:46] USR-MODIFIED-YES (level: 88)
    public static final String USR_MODIFIED_YES = "Y";
    // [T-Up#INFO][COUSR02C.cbl:47] USR-MODIFIED-NO (level: 88)
