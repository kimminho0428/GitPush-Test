...
public @AllArgsConstructor @NoArgsConstructor class Corpt00cWsVariables {
    // [T-Up#INFO][CORPT00C.cbl:37] WS-PGMNAME (level: 5)
    private @Getter String wsPgmname = "CORPT00C";
    // [T-Up#INFO][CORPT00C.cbl:38] WS-TRANID (level: 5)
    private @Getter String wsTranid = "CR00";
    // [T-Up#INFO][CORPT00C.cbl:39] WS-MESSAGE (level: 5)
    private @Getter String wsMessage = StringUtils.repeat(' ', 80);
    // [T-Up#INFO][CORPT00C.cbl:40] WS-TRANSACT-FILE (level: 5)
    private @Getter String wsTransactFile = "TRANSACT";
    // [T-Up#INFO][CORPT00C.cbl:41] WS-ERR-FLG (level: 5)
    private @Getter String wsErrFlg = "N";
    // [T-Up#INFO][CORPT00C.cbl:42] ERR-FLG-ON (level: 88)
    public static final String ERR_FLG_ON = "Y";
    // [T-Up#INFO][CORPT00C.cbl:43] ERR-FLG-OFF (level: 88)
    public static final String ERR_FLG_OFF = "N";
    // [T-Up#INFO][CORPT00C.cbl:44] WS-TRANSACT-EOF (level: 5)
    private @Getter String wsTransactEof = "N";
    // [T-Up#INFO][CORPT00C.cbl:45] TRANSACT-EOF (level: 88)
    public static final String TRANSACT_EOF = "Y";
    // [T-Up#INFO][CORPT00C.cbl:46] TRANSACT-NOT-EOF (level: 88)
    public static final String TRANSACT_NOT_EOF = "N";
    // [T-Up#INFO][CORPT00C.cbl:47] WS-SEND-ERASE-FLG (level: 5)
    private @Getter String wsSendEraseFlg = "Y";
    // [T-Up#INFO][CORPT00C.cbl:48] SEND-ERASE-YES (level: 88)
    public static final String SEND_ERASE_YES = "Y";
    // [T-Up#INFO][CORPT00C.cbl:49] SEND-ERASE-NO (level: 88)
    public static final String SEND_ERASE_NO = "N";
    // [T-Up#INFO][CORPT00C.cbl:50] WS-END-LOOP (level: 5)
    private @Getter String wsEndLoop = "N";
    // [T-Up#INFO][CORPT00C.cbl:51] END-LOOP-YES (level: 88)
    public static final String END_LOOP_YES = "Y";
    // [T-Up#INFO][CORPT00C.cbl:52] END-LOOP-NO (level: 88)
    public static final String END_LOOP_NO = "N";
    // [T-Up#INFO][CORPT00C.cbl:54] WS-RESP-CD (level: 5)
    private @Getter @Setter int wsRespCd = 0;
    // [T-Up#INFO][CORPT00C.cbl:55] WS-REAS-CD (level: 5)
    private @Getter @Setter int wsReasCd = 0;
    // [T-Up#INFO][CORPT00C.cbl:56] WS-REC-COUNT (level: 5)
    private @Getter @Setter int wsRecCount = 0;
    // [T-Up#INFO][CORPT00C.cbl:57] WS-IDX (level: 5)
    private @Getter @Setter int wsIdx = 0;
    // [T-Up#INFO][CORPT00C.cbl:58] WS-REPORT-NAME (level: 5)
    private @Getter String wsReportName = StringUtils.repeat(' ', 10);
    // [T-Up#INFO][CORPT00C.cbl:60] WS-START-DATE (level: 5)
    private @Getter @Setter Corpt00cWsStartDate wsStartDate = new Corpt00cWsStartDate();
    // [T-Up#INFO][CORPT00C.cbl:66] WS-END-DATE (level: 5)
    private @Getter @Setter Corpt00cWsEndDate wsEndDate = new Corpt00cWsEndDate();
    // [T-Up#INFO][CORPT00C.cbl:72] WS-DATE-FORMAT (level: 5)
    private @Getter String wsDateFormat = "YYYY-MM-DD";
    // [T-Up#INFO][CORPT00C.cbl:74] WS-NUM-99 (level: 5)
    private @Getter @Setter int wsNum99 = 0;
    // [T-Up#INFO][CORPT00C.cbl:75] WS-NUM-9999 (level: 5)
    private @Getter @Setter int wsNum9999 = 0;
    // [T-Up#INFO][CORPT00C.cbl:77] WS-TRAN-AMT (level: 5)
    ...
    // [T-Up#INFO][CORPT00C.cbl:78] WS-TRAN-DATE (level: 5)
    private @Getter String wsTranDate = "00/00/00";
    // [T-Up#INFO][CORPT00C.cbl:79] JCL-RECORD (level: 5)
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Corpt00cWsStartDate {
        // [T-Up#INFO][CORPT00C.cbl:61] WS-START-DATE-YYYY (level: 10)
        private @Getter String wsStartDateYyyy = StringUtils.repeat(' ', 4);
        // [T-Up#INFO][CORPT00C.cbl:62] FILLER (level: 10)
        private @Getter String FILLER_1 = "-";
        // [T-Up#INFO][CORPT00C.cbl:63] WS-START-DATE-MM (level: 10)
        private @Getter String wsStartDateMm = StringUtils.repeat(' ', 2);
        // [T-Up#INFO][CORPT00C.cbl:64] FILLER (level: 10)
        private @Getter String FILLER_2 = "-";
        // [T-Up#INFO][CORPT00C.cbl:65] WS-START-DATE-DD (level: 10)
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Corpt00cWsEndDate {
        // [T-Up#INFO][CORPT00C.cbl:67] WS-END-DATE-YYYY (level: 10)
        private @Getter String wsEndDateYyyy = StringUtils.repeat(' ', 4);
        // [T-Up#INFO][CORPT00C.cbl:68] FILLER (level: 10)
        private @Getter String FILLER_3 = "-";
        // [T-Up#INFO][CORPT00C.cbl:69] WS-END-DATE-MM (level: 10)
        private @Getter String wsEndDateMm = StringUtils.repeat(' ', 2);
        // [T-Up#INFO][CORPT00C.cbl:70] FILLER (level: 10)
        private @Getter String FILLER_4 = "-";
        // [T-Up#INFO][CORPT00C.cbl:71] WS-END-DATE-DD (level: 10)
