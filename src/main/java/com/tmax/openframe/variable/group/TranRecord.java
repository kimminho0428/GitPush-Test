...
public @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class TranRecord {
    ...
    public String get() {
        ...
        sb.append(CobStream.convZonedBigDecimalToString(getTranAmt(), 11, 2));
        sb.append(CobStream.convZonedIntToString(getTranMerchantId(), 9));
