 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Cbtrn03cTranfileStatus {
    // [T-Up#INFO][CBTRN03C.cbl:95] TRANFILE-STAT1 (level: 5)
    private @Getter String tranfileStat1 = StringUtils.repeat(' ', 1);
    // [T-Up#INFO][CBTRN03C.cbl:96] TRANFILE-STAT2 (level: 5)
