 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Cbtrn01cFdCustfileRec {
    // [T-Up#INFO][CBTRN01C.cbl:73] FD-CUST-ID (level: 5)
    private @Getter @Setter int fdCustId;
    // [T-Up#INFO][CBTRN01C.cbl:74] FD-CUST-DATA (level: 5)
