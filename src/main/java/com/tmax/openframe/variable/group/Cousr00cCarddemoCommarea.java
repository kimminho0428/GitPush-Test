...
public @AllArgsConstructor @NoArgsConstructor class Cousr00cCarddemoCommarea {
    ...
    // *
    // [T-Up#INFO][COUSR00C.cbl:67] CDEMO-CU00-INFO (level: 5)
    ...
    public void set(String source) {
        ...
        getCdemoCu00Info().set(source.substring(160, 194));
    }
    ...
    public String get() {
        ...
        sb.append(getCdemoCu00Info().get());
        return sb.toString();
    }
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cousr00cCdemoCu00Info {
        // [T-Up#INFO][COUSR00C.cbl:68] CDEMO-CU00-USRID-FIRST (level: 10)
        private @Getter String cdemoCu00UsridFirst = StringUtils.repeat(' ', 8);
        // [T-Up#INFO][COUSR00C.cbl:69] CDEMO-CU00-USRID-LAST (level: 10)
        private @Getter String cdemoCu00UsridLast = StringUtils.repeat(' ', 8);
        // [T-Up#INFO][COUSR00C.cbl:70] CDEMO-CU00-PAGE-NUM (level: 10)
        private @Getter @Setter int cdemoCu00PageNum;
        // [T-Up#INFO][COUSR00C.cbl:71] CDEMO-CU00-NEXT-PAGE-FLG (level: 10)
        private @Getter String cdemoCu00NextPageFlg = "N";
        // [T-Up#INFO][COUSR00C.cbl:72] NEXT-PAGE-YES (level: 88)
        public static final String NEXT_PAGE_YES = "Y";
        // [T-Up#INFO][COUSR00C.cbl:73] NEXT-PAGE-NO (level: 88)
        public static final String NEXT_PAGE_NO = "N";
        // [T-Up#INFO][COUSR00C.cbl:74] CDEMO-CU00-USR-SEL-FLG (level: 10)
        private @Getter String cdemoCu00UsrSelFlg = StringUtils.repeat(' ', 1);
        // [T-Up#INFO][COUSR00C.cbl:75] CDEMO-CU00-USR-SELECTED (level: 10)
        private @Getter String cdemoCu00UsrSelected = StringUtils
                .repeat(' ', 8);

        public void set(String source) {
            source = StringUtils.truncate(StringUtils.rightPad(source, 34), 34);
            setCdemoCu00UsridFirst(source.substring(0, 8));
            setCdemoCu00UsridLast(source.substring(8, 16));
            try {
                setCdemoCu00PageNum(CobStream.convZonedStringToInt(
                        source.substring(16, 24), 8));
            } catch (NumberFormatException exception) {
                exception.printStackTrace();
                setCdemoCu00PageNum(0);
            }
            setCdemoCu00NextPageFlg(source.substring(24, 25));
            setCdemoCu00UsrSelFlg(source.substring(25, 26));
            setCdemoCu00UsrSelected(source.substring(26, 34));
        }
        ...
        public String get() {
            ...
            sb.append(CobStream.convZonedIntToString(getCdemoCu00PageNum(), 8));
        ...
        public String toString() {
            ...
            sb.append(getCdemoCu00UsridLast());
            sb.append(PictureFormatter.intFormatWithoutSign(
                    (long) getCdemoCu00PageNum(), "00000000"));
            sb.append(getCdemoCu00NextPageFlg());
            sb.append(getCdemoCu00UsrSelFlg());
            sb.append(getCdemoCu00UsrSelected());
            return sb.toString();
