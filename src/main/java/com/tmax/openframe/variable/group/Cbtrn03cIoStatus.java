 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Cbtrn03cIoStatus {
    // [T-Up#INFO][CBTRN03C.cbl:140] IO-STAT1 (level: 5)
    private @Getter String ioStat1 = StringUtils.repeat(' ', 1);
    // [T-Up#INFO][CBTRN03C.cbl:141] IO-STAT2 (level: 5)
