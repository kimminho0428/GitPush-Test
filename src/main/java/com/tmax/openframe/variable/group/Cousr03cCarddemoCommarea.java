...
public @AllArgsConstructor @NoArgsConstructor class Cousr03cCarddemoCommarea {
    ...
    // *
    // [T-Up#INFO][COUSR03C.cbl:50] CDEMO-CU03-INFO (level: 5)
    ...
    public void set(String source) {
        ...
        getCdemoCu03Info().set(source.substring(160, 194));
    }
    ...
    public String get() {
        ...
        sb.append(getCdemoCu03Info().get());
        return sb.toString();
    }
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Cousr03cCdemoCu03Info {
        // [T-Up#INFO][COUSR03C.cbl:51] CDEMO-CU03-USRID-FIRST (level: 10)
        private @Getter String cdemoCu03UsridFirst = StringUtils.repeat(' ', 8);
        // [T-Up#INFO][COUSR03C.cbl:52] CDEMO-CU03-USRID-LAST (level: 10)
        private @Getter String cdemoCu03UsridLast = StringUtils.repeat(' ', 8);
        // [T-Up#INFO][COUSR03C.cbl:53] CDEMO-CU03-PAGE-NUM (level: 10)
        private @Getter @Setter int cdemoCu03PageNum;
        // [T-Up#INFO][COUSR03C.cbl:54] CDEMO-CU03-NEXT-PAGE-FLG (level: 10)
        private @Getter String cdemoCu03NextPageFlg = "N";
        // [T-Up#INFO][COUSR03C.cbl:55] NEXT-PAGE-YES (level: 88)
        public static final String NEXT_PAGE_YES = "Y";
        // [T-Up#INFO][COUSR03C.cbl:56] NEXT-PAGE-NO (level: 88)
        public static final String NEXT_PAGE_NO = "N";
        // [T-Up#INFO][COUSR03C.cbl:57] CDEMO-CU03-USR-SEL-FLG (level: 10)
        private @Getter String cdemoCu03UsrSelFlg = StringUtils.repeat(' ', 1);
        // [T-Up#INFO][COUSR03C.cbl:58] CDEMO-CU03-USR-SELECTED (level: 10)
        private @Getter String cdemoCu03UsrSelected = StringUtils
                .repeat(' ', 8);

        public void set(String source) {
            source = StringUtils.truncate(StringUtils.rightPad(source, 34), 34);
            setCdemoCu03UsridFirst(source.substring(0, 8));
            setCdemoCu03UsridLast(source.substring(8, 16));
            try {
                setCdemoCu03PageNum(CobStream.convZonedStringToInt(
                        source.substring(16, 24), 8));
            } catch (NumberFormatException exception) {
                exception.printStackTrace();
                setCdemoCu03PageNum(0);
            }
            setCdemoCu03NextPageFlg(source.substring(24, 25));
            setCdemoCu03UsrSelFlg(source.substring(25, 26));
            setCdemoCu03UsrSelected(source.substring(26, 34));
        }
        ...
        public String get() {
            ...
            sb.append(CobStream.convZonedIntToString(getCdemoCu03PageNum(), 8));
        ...
        public String toString() {
            ...
            sb.append(getCdemoCu03UsridLast());
            sb.append(PictureFormatter.intFormatWithoutSign(
                    (long) getCdemoCu03PageNum(), "00000000"));
            sb.append(getCdemoCu03NextPageFlg());
            sb.append(getCdemoCu03UsrSelFlg());
            sb.append(getCdemoCu03UsrSelected());
            return sb.toString();
