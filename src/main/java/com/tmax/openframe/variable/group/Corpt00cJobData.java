...
public @AllArgsConstructor @NoArgsConstructor class Corpt00cJobData {
    // [T-Up#INFO][CORPT00C.cbl:82] JOB-DATA-1 (level: 2)
    ...
    public String[] getJobLines() {
        return (getJobData1().getFILLER_1() + getJobData1().getFILLER_2()
                ...
                + getJobData1().getFILLER_19() + getJobData1().getFILLER_20())
                .split("(?<=\\G.{80})");
    }
    ...
    public String getJobLines(int index) {
        if (index == 0) {
            ...
            return getJobData1().getFILLER_20();
        } else {
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Corpt00cFiller1 {
        // [T-Up#INFO][CORPT00C.cbl:104] FILLER (level: 10)
        private @Getter String FILLER_11 = "PARM-START-DATE,C'";
        // [T-Up#INFO][CORPT00C.cbl:106] PARM-START-DATE-1 (level: 10)
        private @Getter String parmStartDate1 = StringUtils.repeat(' ', 10);
        // [T-Up#INFO][CORPT00C.cbl:107] FILLER (level: 10)
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Corpt00cFiller2 {
        // [T-Up#INFO][CORPT00C.cbl:109] FILLER (level: 10)
        private @Getter String FILLER_13 = "PARM-END-DATE,C'";
        // [T-Up#INFO][CORPT00C.cbl:111] PARM-END-DATE-1 (level: 10)
        private @Getter String parmEndDate1 = StringUtils.repeat(' ', 10);
        // [T-Up#INFO][CORPT00C.cbl:112] FILLER (level: 10)
    ...
    public static @AllArgsConstructor @NoArgsConstructor class Corpt00cFiller3 {
        // [T-Up#INFO][CORPT00C.cbl:118] PARM-START-DATE-2 (level: 10)
        private @Getter String parmStartDate2 = StringUtils.repeat(' ', 10);
        // [T-Up#INFO][CORPT00C.cbl:119] FILLER (level: 10)
        private @Getter String FILLER_17 = " ";
        // [T-Up#INFO][CORPT00C.cbl:120] PARM-END-DATE-2 (level: 10)
        private @Getter String parmEndDate2 = StringUtils.repeat(' ', 10);
        // [T-Up#INFO][CORPT00C.cbl:121] FILLER (level: 10)
    ...
    public static @AllArgsConstructor @NoArgsConstructor @Builder(builderClassName = "builder") class Corpt00cJobData2 {
        // [T-Up#INFO][CORPT00C.cbl:127] JOB-LINES (level: 5)
