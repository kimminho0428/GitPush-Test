 ...
 */
public @AllArgsConstructor @NoArgsConstructor class Cbtrn01cXreffileStatus {
    // [T-Up#INFO][CBTRN01C.cbl:111] XREFFILE-STAT1 (level: 5)
    private @Getter String xreffileStat1 = StringUtils.repeat(' ', 1);
    // [T-Up#INFO][CBTRN01C.cbl:112] XREFFILE-STAT2 (level: 5)
