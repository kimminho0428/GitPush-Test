 ...
 * <hr>
 * <p>Class that defines variables for COBOL group item CARD-RECORD</p>
 */
public @AllArgsConstructor @NoArgsConstructor class CodsCardRecord {
    // [T-Up#INFO][CODS.cbl:44] CARD-NUM (level: 5)
    private @Getter String cardNum = StringUtils.repeat(' ', 16);
    // [T-Up#INFO][CODS.cbl:45] CARD-ACCT-ID (level: 5)
    private @Getter @Setter long cardAcctId;
    // [T-Up#INFO][CODS.cbl:46] CARD-CVV-CD (level: 5)
    private @Getter @Setter int cardCvvCd;
    // [T-Up#INFO][CODS.cbl:47] CARD-EMBOSSED-NAME (level: 5)
    private @Getter String cardEmbossedName = StringUtils.repeat(' ', 50);
    // [T-Up#INFO][CODS.cbl:48] CARD-EXPIRAION-DATE (level: 5)
    private @Getter String cardExpiraionDate = StringUtils.repeat(' ', 10);
    // [T-Up#INFO][CODS.cbl:49] CARD-ACTIVE-STATUS (level: 5)
    private @Getter String cardActiveStatus = StringUtils.repeat(' ', 1);
    // [T-Up#INFO][CODS.cbl:50] FILLER (level: 5)
    private @Getter String FILLER_1 = StringUtils.repeat(' ', 59);
