...
public class Coadm01cVariableContainer {
    ...
    // *----------------------------------------------------------------*
    // [T-Up#INFO][COADM01C.cbl:35] WS-VARIABLES (level: 1)
    ...
    // *
    //       *COPY COADM02Y.
    // *(/home/oflab/repository/pds/TEST/COBOL_COPYBOOK/COADM02Y.cpy)
    // ******************************************************************
    ...
    // * language governing permissions and limitations under the License
    // ******************************************************************
    // [T-Up#INFO][COADM02Y.cpy:20] CARDDEMO-ADMIN-MENU-OPTIONS (level: 1)
    private @Getter @Setter CarddemoAdminMenuOptions carddemoAdminMenuOptions = new CarddemoAdminMenuOptions();
    // *
    // * Ver: CardDemo_v1.0-26-g42273c1-79 Date: 2022-07-20 16:59:12 CDT
    // *
    //       *COPY COADM01.
    // *(/home/oflab/repository/pds/TEST/COBOL_COPYBOOK/COADM01.CPY)
    // ******************************************************************
    // * Copyright Amazon.com, Inc. or its affiliates.
    // * All Rights Reserved.
    // *
    ...
    // * language governing permissions and limitations under the License
    // ******************************************************************
    // [T-Up#INFO][COADM01.CPY:18] COADM1AI (level: 1)
    private @Getter @Setter Coadm1ai coadm1ai = new Coadm1ai();
    //       *COPY COTTL01Y.
    ...
    public void setCoadm1ao(Coadm01cCoadm1ao source) {
        setCoadm1ao(source.get());
    }

    public String getFILLER_REDEFINE_41() {
        return getCoadm1ai().getFILLER_1();
    }

    public void setFILLER_REDEFINE_41(String source) {
        getCoadm1ai().setFILLER_1(source);
    }

    public String getFILLER_REDEFINE_42() {
        return CobStream.convShortToString((short) getCoadm1ai().getTrnnamel())
                + getCoadm1ai().getTrnnamef();
    }

    public void setFILLER_REDEFINE_42(String source) {
        try {
            getCoadm1ai().setTrnnamel(
                    CobStream.convStringToShort(source.substring(0, 2)));
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            getCoadm1ai().setTrnnamel(0);
        }
        getCoadm1ai().setTrnnamef(source.substring(2, 3));
    }

    public String getTrnnamec() {
        return getCoadm1ai().getFILLER_2().substring(0, 1);
    }

    public void setTrnnamec(String source) {
        getCoadm1ai().setFILLER_2(
                StringUtils.overlay(getCoadm1ai().getFILLER_2(), source, 0, 1));
    }

    public String getTrnnamep() {
        return getCoadm1ai().getFILLER_2().substring(1, 2);
    }

    public void setTrnnamep(String source) {
        getCoadm1ai().setFILLER_2(
                StringUtils.overlay(getCoadm1ai().getFILLER_2(), source, 1, 2));
    }

    public String getTrnnameh() {
        return getCoadm1ai().getFILLER_2().substring(2, 3);
    }

    public void setTrnnameh(String source) {
        getCoadm1ai().setFILLER_2(
                StringUtils.overlay(getCoadm1ai().getFILLER_2(), source, 2, 3));
    }

    public String getTrnnamev() {
        return getCoadm1ai().getFILLER_2().substring(3, 4);
    }

    public void setTrnnamev(String source) {
        getCoadm1ai().setFILLER_2(
                StringUtils.overlay(getCoadm1ai().getFILLER_2(), source, 3, 4));
    }
    ...
    public String getFILLER_REDEFINE_43() {
        return CobStream.convShortToString((short) getCoadm1ai().getTitle01l())
                + getCoadm1ai().getTitle01f();
    }

    public void setFILLER_REDEFINE_43(String source) {
        try {
            getCoadm1ai().setTitle01l(
                    CobStream.convStringToShort(source.substring(0, 2)));
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            getCoadm1ai().setTitle01l(0);
        }
        getCoadm1ai().setTitle01f(source.substring(2, 3));
    }

    public String getTitle01c() {
        return getCoadm1ai().getFILLER_3().substring(0, 1);
    }

    public void setTitle01c(String source) {
        getCoadm1ai().setFILLER_3(
                StringUtils.overlay(getCoadm1ai().getFILLER_3(), source, 0, 1));
    }

    public String getTitle01p() {
        return getCoadm1ai().getFILLER_3().substring(1, 2);
    }

    public void setTitle01p(String source) {
        getCoadm1ai().setFILLER_3(
                StringUtils.overlay(getCoadm1ai().getFILLER_3(), source, 1, 2));
    }

    public String getTitle01h() {
        return getCoadm1ai().getFILLER_3().substring(2, 3);
    }

    public void setTitle01h(String source) {
        getCoadm1ai().setFILLER_3(
                StringUtils.overlay(getCoadm1ai().getFILLER_3(), source, 2, 3));
    }

    public String getTitle01v() {
        return getCoadm1ai().getFILLER_3().substring(3, 4);
    }

    public void setTitle01v(String source) {
        getCoadm1ai().setFILLER_3(
                StringUtils.overlay(getCoadm1ai().getFILLER_3(), source, 3, 4));
    }
    ...
    public String getFILLER_REDEFINE_44() {
        return CobStream.convShortToString((short) getCoadm1ai().getCurdatel())
                + getCoadm1ai().getCurdatef();
    }

    public void setFILLER_REDEFINE_44(String source) {
        try {
            getCoadm1ai().setCurdatel(
                    CobStream.convStringToShort(source.substring(0, 2)));
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            getCoadm1ai().setCurdatel(0);
        }
        getCoadm1ai().setCurdatef(source.substring(2, 3));
    }

    public String getCurdatec() {
        return getCoadm1ai().getFILLER_4().substring(0, 1);
    }

    public void setCurdatec(String source) {
        getCoadm1ai().setFILLER_4(
                StringUtils.overlay(getCoadm1ai().getFILLER_4(), source, 0, 1));
    }

    public String getCurdatep() {
        return getCoadm1ai().getFILLER_4().substring(1, 2);
    }

    public void setCurdatep(String source) {
        getCoadm1ai().setFILLER_4(
                StringUtils.overlay(getCoadm1ai().getFILLER_4(), source, 1, 2));
    }

    public String getCurdateh() {
        return getCoadm1ai().getFILLER_4().substring(2, 3);
    }

    public void setCurdateh(String source) {
        getCoadm1ai().setFILLER_4(
                StringUtils.overlay(getCoadm1ai().getFILLER_4(), source, 2, 3));
    }

    public String getCurdatev() {
        return getCoadm1ai().getFILLER_4().substring(3, 4);
    }

    public void setCurdatev(String source) {
        getCoadm1ai().setFILLER_4(
                StringUtils.overlay(getCoadm1ai().getFILLER_4(), source, 3, 4));
    }
    ...
    public String getFILLER_REDEFINE_45() {
        return CobStream.convShortToString((short) getCoadm1ai().getPgmnamel())
                + getCoadm1ai().getPgmnamef();
    }

    public void setFILLER_REDEFINE_45(String source) {
        try {
            getCoadm1ai().setPgmnamel(
                    CobStream.convStringToShort(source.substring(0, 2)));
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            getCoadm1ai().setPgmnamel(0);
        }
        getCoadm1ai().setPgmnamef(source.substring(2, 3));
    }

    public String getPgmnamec() {
        return getCoadm1ai().getFILLER_5().substring(0, 1);
    }

    public void setPgmnamec(String source) {
        getCoadm1ai().setFILLER_5(
                StringUtils.overlay(getCoadm1ai().getFILLER_5(), source, 0, 1));
    }

    public String getPgmnamep() {
        return getCoadm1ai().getFILLER_5().substring(1, 2);
    }

    public void setPgmnamep(String source) {
        getCoadm1ai().setFILLER_5(
                StringUtils.overlay(getCoadm1ai().getFILLER_5(), source, 1, 2));
    }

    public String getPgmnameh() {
        return getCoadm1ai().getFILLER_5().substring(2, 3);
    }

    public void setPgmnameh(String source) {
        getCoadm1ai().setFILLER_5(
                StringUtils.overlay(getCoadm1ai().getFILLER_5(), source, 2, 3));
    }

    public String getPgmnamev() {
        return getCoadm1ai().getFILLER_5().substring(3, 4);
    }

    public void setPgmnamev(String source) {
        getCoadm1ai().setFILLER_5(
                StringUtils.overlay(getCoadm1ai().getFILLER_5(), source, 3, 4));
    }
    ...
    public String getFILLER_REDEFINE_46() {
        return CobStream.convShortToString((short) getCoadm1ai().getTitle02l())
                + getCoadm1ai().getTitle02f();
    }

    public void setFILLER_REDEFINE_46(String source) {
        try {
            getCoadm1ai().setTitle02l(
                    CobStream.convStringToShort(source.substring(0, 2)));
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            getCoadm1ai().setTitle02l(0);
        }
        getCoadm1ai().setTitle02f(source.substring(2, 3));
    }

    public String getTitle02c() {
        return getCoadm1ai().getFILLER_6().substring(0, 1);
    }

    public void setTitle02c(String source) {
        getCoadm1ai().setFILLER_6(
                StringUtils.overlay(getCoadm1ai().getFILLER_6(), source, 0, 1));
    }

    public String getTitle02p() {
        return getCoadm1ai().getFILLER_6().substring(1, 2);
    }

    public void setTitle02p(String source) {
        getCoadm1ai().setFILLER_6(
                StringUtils.overlay(getCoadm1ai().getFILLER_6(), source, 1, 2));
    }

    public String getTitle02h() {
        return getCoadm1ai().getFILLER_6().substring(2, 3);
    }

    public void setTitle02h(String source) {
        getCoadm1ai().setFILLER_6(
                StringUtils.overlay(getCoadm1ai().getFILLER_6(), source, 2, 3));
    }

    public String getTitle02v() {
        return getCoadm1ai().getFILLER_6().substring(3, 4);
    }

    public void setTitle02v(String source) {
        getCoadm1ai().setFILLER_6(
                StringUtils.overlay(getCoadm1ai().getFILLER_6(), source, 3, 4));
    }
    ...
    public String getFILLER_REDEFINE_47() {
        return CobStream.convShortToString((short) getCoadm1ai().getCurtimel())
                + getCoadm1ai().getCurtimef();
    }

    public void setFILLER_REDEFINE_47(String source) {
        try {
            getCoadm1ai().setCurtimel(
                    CobStream.convStringToShort(source.substring(0, 2)));
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            getCoadm1ai().setCurtimel(0);
        }
        getCoadm1ai().setCurtimef(source.substring(2, 3));
    }

    public String getCurtimec() {
        return getCoadm1ai().getFILLER_7().substring(0, 1);
    }

    public void setCurtimec(String source) {
        getCoadm1ai().setFILLER_7(
                StringUtils.overlay(getCoadm1ai().getFILLER_7(), source, 0, 1));
    }

    public String getCurtimep() {
        return getCoadm1ai().getFILLER_7().substring(1, 2);
    }

    public void setCurtimep(String source) {
        getCoadm1ai().setFILLER_7(
                StringUtils.overlay(getCoadm1ai().getFILLER_7(), source, 1, 2));
    }

    public String getCurtimeh() {
        return getCoadm1ai().getFILLER_7().substring(2, 3);
    }

    public void setCurtimeh(String source) {
        getCoadm1ai().setFILLER_7(
                StringUtils.overlay(getCoadm1ai().getFILLER_7(), source, 2, 3));
    }

    public String getCurtimev() {
        return getCoadm1ai().getFILLER_7().substring(3, 4);
    }

    public void setCurtimev(String source) {
        getCoadm1ai().setFILLER_7(
                StringUtils.overlay(getCoadm1ai().getFILLER_7(), source, 3, 4));
    }
    ...
    public String getFILLER_REDEFINE_48() {
        return CobStream.convShortToString((short) getCoadm1ai().getOptn001l())
                + getCoadm1ai().getOptn001f();
    }

    public void setFILLER_REDEFINE_48(String source) {
        try {
            getCoadm1ai().setOptn001l(
                    CobStream.convStringToShort(source.substring(0, 2)));
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            getCoadm1ai().setOptn001l(0);
        }
        getCoadm1ai().setOptn001f(source.substring(2, 3));
    }

    public String getOptn001c() {
        return getCoadm1ai().getFILLER_8().substring(0, 1);
    }

    public void setOptn001c(String source) {
        getCoadm1ai().setFILLER_8(
                StringUtils.overlay(getCoadm1ai().getFILLER_8(), source, 0, 1));
    }

    public String getOptn001p() {
        return getCoadm1ai().getFILLER_8().substring(1, 2);
    }

    public void setOptn001p(String source) {
        getCoadm1ai().setFILLER_8(
                StringUtils.overlay(getCoadm1ai().getFILLER_8(), source, 1, 2));
    }

    public String getOptn001h() {
        return getCoadm1ai().getFILLER_8().substring(2, 3);
    }

    public void setOptn001h(String source) {
        getCoadm1ai().setFILLER_8(
                StringUtils.overlay(getCoadm1ai().getFILLER_8(), source, 2, 3));
    }

    public String getOptn001v() {
        return getCoadm1ai().getFILLER_8().substring(3, 4);
    }

    public void setOptn001v(String source) {
        getCoadm1ai().setFILLER_8(
                StringUtils.overlay(getCoadm1ai().getFILLER_8(), source, 3, 4));
    }
    ...
    public String getFILLER_REDEFINE_49() {
        return CobStream.convShortToString((short) getCoadm1ai().getOptn002l())
                + getCoadm1ai().getOptn002f();
    }

    public void setFILLER_REDEFINE_49(String source) {
        try {
            getCoadm1ai().setOptn002l(
                    CobStream.convStringToShort(source.substring(0, 2)));
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            getCoadm1ai().setOptn002l(0);
        }
        getCoadm1ai().setOptn002f(source.substring(2, 3));
    }

    public String getOptn002c() {
        return getCoadm1ai().getFILLER_9().substring(0, 1);
    }

    public void setOptn002c(String source) {
        getCoadm1ai().setFILLER_9(
                StringUtils.overlay(getCoadm1ai().getFILLER_9(), source, 0, 1));
    }

    public String getOptn002p() {
        return getCoadm1ai().getFILLER_9().substring(1, 2);
    }

    public void setOptn002p(String source) {
        getCoadm1ai().setFILLER_9(
                StringUtils.overlay(getCoadm1ai().getFILLER_9(), source, 1, 2));
    }

    public String getOptn002h() {
        return getCoadm1ai().getFILLER_9().substring(2, 3);
    }

    public void setOptn002h(String source) {
        getCoadm1ai().setFILLER_9(
                StringUtils.overlay(getCoadm1ai().getFILLER_9(), source, 2, 3));
    }

    public String getOptn002v() {
        return getCoadm1ai().getFILLER_9().substring(3, 4);
    }

    public void setOptn002v(String source) {
        getCoadm1ai().setFILLER_9(
                StringUtils.overlay(getCoadm1ai().getFILLER_9(), source, 3, 4));
    }
    ...
    public String getFILLER_REDEFINE_50() {
        return CobStream.convShortToString((short) getCoadm1ai().getOptn003l())
                + getCoadm1ai().getOptn003f();
    }

    public void setFILLER_REDEFINE_50(String source) {
        try {
            getCoadm1ai().setOptn003l(
                    CobStream.convStringToShort(source.substring(0, 2)));
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            getCoadm1ai().setOptn003l(0);
        }
        getCoadm1ai().setOptn003f(source.substring(2, 3));
    }

    public String getOptn003c() {
        return getCoadm1ai().getFILLER_10().substring(0, 1);
    }

    public void setOptn003c(String source) {
        getCoadm1ai()
                .setFILLER_10(
                        StringUtils.overlay(getCoadm1ai().getFILLER_10(),
                                source, 0, 1));
    }

    public String getOptn003p() {
        return getCoadm1ai().getFILLER_10().substring(1, 2);
    }
    ...
    public String getOptn003h() {
        return getCoadm1ai().getFILLER_10().substring(2, 3);
    }
    ...
    public String getOptn003v() {
        return getCoadm1ai().getFILLER_10().substring(3, 4);
    }
    ...
    public String getFILLER_REDEFINE_51() {
        return CobStream.convShortToString((short) getCoadm1ai().getOptn004l())
                + getCoadm1ai().getOptn004f();
    }

    public void setFILLER_REDEFINE_51(String source) {
        try {
            getCoadm1ai().setOptn004l(
                    CobStream.convStringToShort(source.substring(0, 2)));
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            getCoadm1ai().setOptn004l(0);
        }
        getCoadm1ai().setOptn004f(source.substring(2, 3));
    }

    public String getOptn004c() {
        return getCoadm1ai().getFILLER_11().substring(0, 1);
    }

    public void setOptn004c(String source) {
        getCoadm1ai()
                .setFILLER_11(
                        StringUtils.overlay(getCoadm1ai().getFILLER_11(),
                                source, 0, 1));
    }

    public String getOptn004p() {
        return getCoadm1ai().getFILLER_11().substring(1, 2);
    }
    ...
    public String getOptn004h() {
        return getCoadm1ai().getFILLER_11().substring(2, 3);
    }
    ...
    public String getOptn004v() {
        return getCoadm1ai().getFILLER_11().substring(3, 4);
    }
    ...
    public String getFILLER_REDEFINE_52() {
        return CobStream.convShortToString((short) getCoadm1ai().getOptn005l())
                + getCoadm1ai().getOptn005f();
    }

    public void setFILLER_REDEFINE_52(String source) {
        try {
            getCoadm1ai().setOptn005l(
                    CobStream.convStringToShort(source.substring(0, 2)));
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            getCoadm1ai().setOptn005l(0);
        }
        getCoadm1ai().setOptn005f(source.substring(2, 3));
    }

    public String getOptn005c() {
        return getCoadm1ai().getFILLER_12().substring(0, 1);
    }

    public void setOptn005c(String source) {
        getCoadm1ai()
                .setFILLER_12(
                        StringUtils.overlay(getCoadm1ai().getFILLER_12(),
                                source, 0, 1));
    }

    public String getOptn005p() {
        return getCoadm1ai().getFILLER_12().substring(1, 2);
    }
    ...
    public String getOptn005h() {
        return getCoadm1ai().getFILLER_12().substring(2, 3);
    }
    ...
    public String getOptn005v() {
        return getCoadm1ai().getFILLER_12().substring(3, 4);
    }
    ...
    public String getFILLER_REDEFINE_53() {
        return CobStream.convShortToString((short) getCoadm1ai().getOptn006l())
                + getCoadm1ai().getOptn006f();
    }

    public void setFILLER_REDEFINE_53(String source) {
        try {
            getCoadm1ai().setOptn006l(
                    CobStream.convStringToShort(source.substring(0, 2)));
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            getCoadm1ai().setOptn006l(0);
        }
        getCoadm1ai().setOptn006f(source.substring(2, 3));
    }

    public String getOptn006c() {
        return getCoadm1ai().getFILLER_13().substring(0, 1);
    }

    public void setOptn006c(String source) {
        getCoadm1ai()
                .setFILLER_13(
                        StringUtils.overlay(getCoadm1ai().getFILLER_13(),
                                source, 0, 1));
    }

    public String getOptn006p() {
        return getCoadm1ai().getFILLER_13().substring(1, 2);
    }
    ...
    public String getOptn006h() {
        return getCoadm1ai().getFILLER_13().substring(2, 3);
    }
    ...
    public String getOptn006v() {
        return getCoadm1ai().getFILLER_13().substring(3, 4);
    }
    ...
    public String getFILLER_REDEFINE_54() {
        return CobStream.convShortToString((short) getCoadm1ai().getOptn007l())
                + getCoadm1ai().getOptn007f();
    }

    public void setFILLER_REDEFINE_54(String source) {
        try {
            getCoadm1ai().setOptn007l(
                    CobStream.convStringToShort(source.substring(0, 2)));
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            getCoadm1ai().setOptn007l(0);
        }
        getCoadm1ai().setOptn007f(source.substring(2, 3));
    }

    public String getOptn007c() {
        return getCoadm1ai().getFILLER_14().substring(0, 1);
    }

    public void setOptn007c(String source) {
        getCoadm1ai()
                .setFILLER_14(
                        StringUtils.overlay(getCoadm1ai().getFILLER_14(),
                                source, 0, 1));
    }

    public String getOptn007p() {
        return getCoadm1ai().getFILLER_14().substring(1, 2);
    }
    ...
    public String getOptn007h() {
        return getCoadm1ai().getFILLER_14().substring(2, 3);
    }
    ...
    public String getOptn007v() {
        return getCoadm1ai().getFILLER_14().substring(3, 4);
    }
    ...
    public String getFILLER_REDEFINE_55() {
        return CobStream.convShortToString((short) getCoadm1ai().getOptn008l())
                + getCoadm1ai().getOptn008f();
    }

    public void setFILLER_REDEFINE_55(String source) {
        try {
            getCoadm1ai().setOptn008l(
                    CobStream.convStringToShort(source.substring(0, 2)));
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            getCoadm1ai().setOptn008l(0);
        }
        getCoadm1ai().setOptn008f(source.substring(2, 3));
    }

    public String getOptn008c() {
        return getCoadm1ai().getFILLER_15().substring(0, 1);
    }

    public void setOptn008c(String source) {
        getCoadm1ai()
                .setFILLER_15(
                        StringUtils.overlay(getCoadm1ai().getFILLER_15(),
                                source, 0, 1));
    }

    public String getOptn008p() {
        return getCoadm1ai().getFILLER_15().substring(1, 2);
    }
    ...
    public String getOptn008h() {
        return getCoadm1ai().getFILLER_15().substring(2, 3);
    }
    ...
    public String getOptn008v() {
        return getCoadm1ai().getFILLER_15().substring(3, 4);
    }
    ...
    public String getFILLER_REDEFINE_56() {
        return CobStream.convShortToString((short) getCoadm1ai().getOptn009l())
                + getCoadm1ai().getOptn009f();
    }

    public void setFILLER_REDEFINE_56(String source) {
        try {
            getCoadm1ai().setOptn009l(
                    CobStream.convStringToShort(source.substring(0, 2)));
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            getCoadm1ai().setOptn009l(0);
        }
        getCoadm1ai().setOptn009f(source.substring(2, 3));
    }

    public String getOptn009c() {
        return getCoadm1ai().getFILLER_16().substring(0, 1);
    }

    public void setOptn009c(String source) {
        getCoadm1ai()
                .setFILLER_16(
                        StringUtils.overlay(getCoadm1ai().getFILLER_16(),
                                source, 0, 1));
    }

    public String getOptn009p() {
        return getCoadm1ai().getFILLER_16().substring(1, 2);
    }
    ...
    public String getOptn009h() {
        return getCoadm1ai().getFILLER_16().substring(2, 3);
    }
    ...
    public String getOptn009v() {
        return getCoadm1ai().getFILLER_16().substring(3, 4);
    }
    ...
    public String getFILLER_REDEFINE_57() {
        return CobStream.convShortToString((short) getCoadm1ai().getOptn010l())
                + getCoadm1ai().getOptn010f();
    }

    public void setFILLER_REDEFINE_57(String source) {
        try {
            getCoadm1ai().setOptn010l(
                    CobStream.convStringToShort(source.substring(0, 2)));
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            getCoadm1ai().setOptn010l(0);
        }
        getCoadm1ai().setOptn010f(source.substring(2, 3));
    }

    public String getOptn010c() {
        return getCoadm1ai().getFILLER_17().substring(0, 1);
    }

    public void setOptn010c(String source) {
        getCoadm1ai()
                .setFILLER_17(
                        StringUtils.overlay(getCoadm1ai().getFILLER_17(),
                                source, 0, 1));
    }

    public String getOptn010p() {
        return getCoadm1ai().getFILLER_17().substring(1, 2);
    }
    ...
    public String getOptn010h() {
        return getCoadm1ai().getFILLER_17().substring(2, 3);
    }
    ...
    public String getOptn010v() {
        return getCoadm1ai().getFILLER_17().substring(3, 4);
    }
    ...
    public String getFILLER_REDEFINE_58() {
        return CobStream.convShortToString((short) getCoadm1ai().getOptn011l())
                + getCoadm1ai().getOptn011f();
    }

    public void setFILLER_REDEFINE_58(String source) {
        try {
            getCoadm1ai().setOptn011l(
                    CobStream.convStringToShort(source.substring(0, 2)));
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            getCoadm1ai().setOptn011l(0);
        }
        getCoadm1ai().setOptn011f(source.substring(2, 3));
    }

    public String getOptn011c() {
        return getCoadm1ai().getFILLER_18().substring(0, 1);
    }

    public void setOptn011c(String source) {
        getCoadm1ai()
                .setFILLER_18(
                        StringUtils.overlay(getCoadm1ai().getFILLER_18(),
                                source, 0, 1));
    }

    public String getOptn011p() {
        return getCoadm1ai().getFILLER_18().substring(1, 2);
    }
    ...
    public String getOptn011h() {
        return getCoadm1ai().getFILLER_18().substring(2, 3);
    }
    ...
    public String getOptn011v() {
        return getCoadm1ai().getFILLER_18().substring(3, 4);
    }
    ...
    public String getFILLER_REDEFINE_59() {
        return CobStream.convShortToString((short) getCoadm1ai().getOptn012l())
                + getCoadm1ai().getOptn012f();
    }

    public void setFILLER_REDEFINE_59(String source) {
        try {
            getCoadm1ai().setOptn012l(
                    CobStream.convStringToShort(source.substring(0, 2)));
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            getCoadm1ai().setOptn012l(0);
        }
        getCoadm1ai().setOptn012f(source.substring(2, 3));
    }

    public String getOptn012c() {
        return getCoadm1ai().getFILLER_19().substring(0, 1);
    }

    public void setOptn012c(String source) {
        getCoadm1ai()
                .setFILLER_19(
                        StringUtils.overlay(getCoadm1ai().getFILLER_19(),
                                source, 0, 1));
    }

    public String getOptn012p() {
        return getCoadm1ai().getFILLER_19().substring(1, 2);
    }
    ...
    public String getOptn012h() {
        return getCoadm1ai().getFILLER_19().substring(2, 3);
    }
    ...
    public String getOptn012v() {
        return getCoadm1ai().getFILLER_19().substring(3, 4);
    }
    ...
    public String getFILLER_REDEFINE_60() {
        return CobStream.convShortToString((short) getCoadm1ai().getOptionl())
                + getCoadm1ai().getOptionf();
    }

    public void setFILLER_REDEFINE_60(String source) {
        try {
            getCoadm1ai().setOptionl(
                    CobStream.convStringToShort(source.substring(0, 2)));
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            getCoadm1ai().setOptionl(0);
        }
        getCoadm1ai().setOptionf(source.substring(2, 3));
    }

    public String getOptionc() {
        return getCoadm1ai().getFILLER_20().substring(0, 1);
    }

    public void setOptionc(String source) {
        getCoadm1ai()
                .setFILLER_20(
                        StringUtils.overlay(getCoadm1ai().getFILLER_20(),
                                source, 0, 1));
    }

    public String getOptionp() {
        return getCoadm1ai().getFILLER_20().substring(1, 2);
    }
    ...
    public String getOptionh() {
        return getCoadm1ai().getFILLER_20().substring(2, 3);
    }
    ...
    public String getOptionv() {
        return getCoadm1ai().getFILLER_20().substring(3, 4);
    }
    ...
    public String getFILLER_REDEFINE_61() {
        return CobStream.convShortToString((short) getCoadm1ai().getErrmsgl())
                + getCoadm1ai().getErrmsgf();
    }

    public void setFILLER_REDEFINE_61(String source) {
        try {
            getCoadm1ai().setErrmsgl(
                    CobStream.convStringToShort(source.substring(0, 2)));
        } catch (NumberFormatException exception) {
            exception.printStackTrace();
            getCoadm1ai().setErrmsgl(0);
        }
        getCoadm1ai().setErrmsgf(source.substring(2, 3));
    }

    public String getErrmsgc() {
        return getCoadm1ai().getFILLER_21().substring(0, 1);
    }

    public void setErrmsgc(String source) {
        getCoadm1ai()
                .setFILLER_21(
                        StringUtils.overlay(getCoadm1ai().getFILLER_21(),
                                source, 0, 1));
    }

    public String getErrmsgp() {
        return getCoadm1ai().getFILLER_21().substring(1, 2);
    }
    ...
    public String getErrmsgh() {
        return getCoadm1ai().getFILLER_21().substring(2, 3);
    }
    ...
    public String getErrmsgv() {
        return getCoadm1ai().getFILLER_21().substring(3, 4);
    }
